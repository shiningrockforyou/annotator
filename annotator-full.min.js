...
! function() {
	...
	Annotator = function(_super) {
		...
		Annotator.prototype.newPosition = null;
		...
		Annotator.prototype.checkForEndSelection = function(event) {
			...
			if (this.ignoreMouseup) {
				return this.newPosition.css(Util.mousePosition(event, this.wrapper[0])).show()
			}
			...
			if (event && this.selectedRanges.length) {
				return this.adder.css('position','absolute').show()
			} else {
		...
		Annotator.prototype.onAdderClick = function(event) {
			...
			position = [this.newPosition.css('top'), this.newPosition.css('left')]
			this.adder.hide();
